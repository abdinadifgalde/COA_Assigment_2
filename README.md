...
Description
This project simulates a simple cache controller using a Finite State Machine (FSM). It processes CPU read/write requests and shows cache hit/miss behavior and memory delays.
